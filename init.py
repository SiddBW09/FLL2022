...
#steering_tank = MoveSteering(OUTPUT_D, OUTPUT_A)
#gyro = GyroSensor(INPUT_1)

# please use this code in all modules to create a tank
# usage: mytank = init_and_create_movetank()
...
def show_sensor_values():
    ...
    print(' Sonic  : ' + str(ultrasonic.distance_centimeters))
    print(' Color L: ' + str(colorLeft.reflected_light_intensity))
